      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 col-sm-12 col-md-8 mb-4">
            ...
            <a href="<?php echo get_page_link(21) ?>" class="mt-3 d-inline-block"
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="text-center border p-4 rounded mb-4">
              <span class="counter text-dark font-weight-normal"><?php the_field('clients') ?></span>
              <h5 class="text-uppercase mt-2">Счастливых клиентов</h5>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="text-center border p-4 rounded mb-4">
              <span class="counter text-dark font-weight-normal"><?php the_field('complete_projects') ?></span>
              <h5 class="text-uppercase mt-2">Завершенных проектов</h5>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="text-center border p-4 rounded mb-4">
              <span class="counter text-dark font-weight-normal"><?php the_field('team') ?></span>
              <h5 class="text-uppercase mt-2">Людей в нашей команде</h5>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="text-center border p-4 rounded">
              <span class="counter text-dark font-weight-normal"><?php the_field('projects') ?></span>
