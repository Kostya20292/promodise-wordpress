      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block col-sm-12">
            <div class="intro-img">
              <img src="<?php echo get_template_directory_uri()?>/images/banner/why-choose.png" alt="intro-img" class="img-fluid" />
            </div>
          </div>
          <div class="col-lg-7 col-md-12 col-sm-12">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="intro-cta">
                  <p class="lead">Остались вопросы? <a href="<?php echo get_page_link(15) ?>" class="smoth-scroll">Напишите нам</a></p>
                </div>
              </div>
            </div>
          </div>
            ...
            while ( $query->have_posts() ) {
             ...
             <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="blog-block">
                  ...
                  <div class="blog-text">
                    <h6 class="author-name"><span><?php $categories = get_the_category(); echo $categories[0]->name;?></span><?php the_author() ?></h6>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6 col-md-6">
            <div class="counter-stat">
              ...
              <span class="counter"><?php the_field('complete_projects') ?></span>
          ...
          <div class="col-lg-3 col-sm-6 col-md-6">
            <div class="counter-stat">
              ...
              <span class="counter"><?php the_field('team') ?></span>
